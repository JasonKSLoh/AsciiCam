...
public class CameraSource {
    ...
    private FrameProcessingRunnable frameProcessingRunnable;
    ...
    public static class Builder {
        ...
        public Builder setRequestedFps(float fps) {
            ...
            cameraSource.mRequestedFps = fps;
            return this;
        }

        public Builder setFocusMode(@FocusMode String mode) {
            cameraSource.mFocusMode = mode;
            return this;
        }

        public Builder setFlashMode(@FlashMode String mode) {
            cameraSource.mFlashMode = mode;
            return this;
        }
        ...
        public Builder setRequestedPreviewSize(int width, int height) {
            ...
            cameraSource.mRequestedPreviewWidth = width;
            cameraSource.mRequestedPreviewHeight = height;
            return this;
        }
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    while (mActive && (pendingFrameData == null)) {
                        try {
...
//                            .setImageData(pendingFrameData, mPreviewSize.getWidth(),
